...
import { Sparkles,Briefcase, FlaskConical, Music, Sticker, Palette,Code, ChevronRight } from "lucide-react";
          ...
          <div className="max-w-md w-full mx-4">
            <form onSubmit={handlePreferenceSubmit} className="space-y-8">
              <div className="text-center">
                ...
                <h1 className="text-3xl font-bold text-white mb-2">Join Creative Space</h1>
                <p className="text-white/70">Connect with similar interest peoples</p>
              </div>
              <div>
                <h2 className="text-white/90 font-medium mb-4">Choose your interests</h2>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-400 to-blue-500 text-white py-4 rounded-2xl font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-opacity flex items-center justify-center gap-2"
              >
                Join Chat Room
